...
<div class="col-md-12 new-collaborators text-center">
    <div class="col-md-offset-2 col-md-2">
        ...
        <img width="20%" src="{{ URL::to('/') }}/themes/{{Session::get('theme')}}/assets/img/people.png"/>
        </a>
    </div>
        <div class="col-md-2">
    ...
    <div class="col-md-2">
        ...
        <img width="30%" src="{{ URL::to('/') }}/themes/{{Session::get('theme')}}/assets/img/cite.png">
        </a>
    </div>
        <div class="col-md-2">
                <a href="pages/contact" target="_blank">
                <img width="25%" src="{{URL::to('/')}}/themes/{{Session::get('theme')}}/assets/img/contact.png">
                </a>
        </div>
</div>